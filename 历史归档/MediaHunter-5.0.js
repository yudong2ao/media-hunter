...
(function () {
    ...
    const STYLES = `
        ...
        #mh-popup { position: absolute; bottom: 0; right: 0; width: 296px; max-height: 255px; background: rgba(255, 255, 255, 1); border-radius: 8px; box-shadow: 0 8px 24px rgba(0,0,0,0.15); display: none; flex-direction: column; overflow: hidden; }
