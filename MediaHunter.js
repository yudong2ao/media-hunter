// ==UserScript==
// @name         MediaHunter 媒体猎手 (V8.2.3 极致交互优化版)
// @namespace    http://tampermonkey.net/
// @version      8.2.3
// @description  Strict rules for ghost resources. Intercept native payload. Extreme performance optimization with chunking and LRU cache. Local API Architecture integration. Auto-close on download success.
    ...
    function renderCards() {
        ...
        sortedList.forEach(media => {
            ...
            if (media._dlUntil && now < media._dlUntil) {
                currentDlText = "下载中";
                dlBtnStyle = "background: #2b8a3e !important;"; // 醒目的绿色
            } else if (media._dlErrUntil && now < media._dlErrUntil) {
                currentDlText = media._dlErrText || "未连接";
                dlBtnStyle = "background: #e03131 !important;"; // 醒目的红色
            }
